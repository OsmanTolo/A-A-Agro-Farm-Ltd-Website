...
function Hero({ smoothScrollTo }) {
  ...
  return (
    ...
    <section
      ...
      style={{
        backgroundImage:
          "url('https://placehold.co/1920x1080/34D399/FFFFFF?text=A%26A+Agro+Farm+Scene')",
      }}
    >
      ...
      <div className="relative z-10 text-center p-6 md:p-12">
        ...
        <p className="text-xl sm:text-2xl font-display mb-6 text-slate-200">
          Cultivating Freshness, Empowering Communities in Sierra Leone
        </p>
        <p className="text-lg text-slate-300 mb-10 max-w-2xl mx-auto">
          Discover the heart of Sierra Leonean agriculture. We are dedicated to
          growing quality produce while nurturing our land and supporting our
          local community.
        </p>
        <a
          href="#about"
